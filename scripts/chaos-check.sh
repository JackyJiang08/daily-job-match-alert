#!/usr/bin/env bash
# Runs seven unattended-failure scenarios against isolated temporary configs and output
...
scenarios=(baseline offline llm-down bad-input xlsx-recovery ats-500 review-cap)
pass_count=0
fail_count=0
results=""
