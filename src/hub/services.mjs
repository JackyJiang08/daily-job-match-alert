...
export function quotaView(ctx, config, latest, state) {
  ...
  return {
    ...
    budgetHistory: Array.isArray(state?.budgetHistory) ? state.budgetHistory.slice(-7) : (latest?.meta?.budgetHistory || []),
    expiredBacklogCount: latest?.meta?.expiredBacklogCount ?? null,
