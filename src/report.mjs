...
export function buildHtml(jobs, meta) {
  ...
  </style></head><body><main class="wrap"><header><h1>Daily Job Match Alert</h1><p class="sub">Application list for ${htmlEscape(meta.date)} · discovered in the previous ${meta.lookbackHours} hours</p></header>${warningSection}
