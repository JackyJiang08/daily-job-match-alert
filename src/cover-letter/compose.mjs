...
export function letterRules({ roleType = 'unknown', graduation = graduationTerms(), inIllinois = false, missing = [], condense = false } = {}) {
  ...
  return [
    ...
    'Never use an em dash or an en dash as punctuation; use commas, periods, or colons. Professional, human, first-person voice; specific and direct; no clichés such as "I am writing to express my interest"; no slang or chatty phrasing.',
